...
use rapiddlt::dlt_v1::{DltExtendedHeader, DltHTyp, DltMsinType, DltStandardHeader, DltStorageHeader};
...
fn main() -> Result<(), std::io::Error> {
    ...
    loop {
        ...
        let eh = DltExtendedHeader::new(DltMsinType::log_message(true), 0, appid.try_into().expect("app id incorrect"), appid.try_into().expect("app id incorrect"));
