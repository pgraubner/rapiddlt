...
for i in {1..2}
do
    cat lc_ex007_large.dlt  >> ../test_gen/lc_ex007_even_larger.dlt
done

# 24495600 DLT entries
for i in {1..10}
do
    cat lc_ex007_large.dlt lc_ex007_large.dlt lc_ex007_large.dlt lc_ex007_large.dlt  >> ../test_gen/1_1gb_concat.dlt
done

# 97982400 DLT entries
cat 1_1gb_concat.dlt 1_1gb_concat.dlt 1_1gb_concat.dlt 1_1gb_concat.dlt  > ../test_gen/4_4gb_concat.dlt
